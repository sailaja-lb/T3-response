...
//
//        final String url = "http://localhost:" + port + "/addResponse?assignmentId=" +
//        assignmentId + "&questionId=" + questionId + "&questionText=" + questionText +
//        "&response=" + response + "&completed=" + completed;
//        TestRestTemplate rest = new TestRestTemplate();
//        doThrow(new ResponseStatusException(expectedStatus)).when(responseService).addResponse
...
//        String url = "http://localhost:" + port + "/updateIsComplete?assignmentId=" +
//        assignmentId;
//        TestRestTemplate rest = new TestRestTemplate();
...
//        Long assignmentId = 1L;
//        String url =
//                "http://localhost:" + port + "/deleteResponsesForAssignment?assignmentId=" +
//                assignmentId;
//        TestRestTemplate rest = new TestRestTemplate();
//        ResponseStatusException exception = new ResponseStatusException(HttpStatus.ACCEPTED);
//
